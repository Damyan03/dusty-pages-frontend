		...
		<>
			...
			<HorizontalScrollableArea title="Featured Articles">
				{featuredArticles.map((article: FeaturedArticleType) => (
					<div key={article.id} className="size-40 center flex-none bg-sub rounded-2xl">
						<Link to={`/article/${article.id}/${article.titleLowerCase}`}>
							{article.title}
						</Link>
					</div>
				))}
			...
			<div className="w-full h-1/3">
				...
				<BigCard
					...
					src="https://easy-peasy.ai/cdn-cgi/image/quality=80,format=auto,width=700/https://media.easy-peasy.ai/4ddbf357-a161-4940-bc6a-7fb833f4cb64/a9dffe49-0975-417f-8b0b-fb063d3d99ac.png"
				/>
			</div>
		</>
	);
